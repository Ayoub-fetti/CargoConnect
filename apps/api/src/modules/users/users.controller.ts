...
export class UsersController {
  ...
  @Patch('me')
  updateProfile(@Request() req, @Body() dto: UpdateDriverProfileDto | UpdateCompanyProfileDto) {
  ...
  uploadDocument(@Request() req, @UploadedFile() file: Express.Multer.File, @Body('type') type: string) {
